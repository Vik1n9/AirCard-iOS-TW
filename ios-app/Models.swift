...
enum AppTab: String, CaseIterable, Identifiable {
    case pairing = "配對"
    case walletCards = "Wallet 卡片"
    case passcodeThemes = "密碼"
    case wallpapers = "桌布"
...
enum CreatorMode: String, CaseIterable, Identifiable {
    case applyTheme = "套用 .passthm"
    case themeCreator = "建立主題"
    var id: String { rawValue }
}

enum SliceMode: String, CaseIterable, Identifiable {
    case posterSlice = "海報裁切"
    case individualKeys = "個別按鍵"
    var id: String { rawValue }
}
...
enum PasscodeBoldTarget: String, CaseIterable, Identifiable {
    case both = "通用（一般 + 粗體）"
    case boldOnly = "僅粗體文字（快速）"
    case regularOnly = "僅一般字體（快速）"
